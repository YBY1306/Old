...
import com.highcapable.yukihookapi.hook.xposed.parasitic.activity.delegate.IActivityManagerProxy_
...
object IActivityManagerProxyImpl_Impl {
    ...
    fun createWrapper(clazz: Class<*>?, instance: Any) = 
        Proxy.newProxyInstance(IActivityManagerProxyCaller.currentClassLoader, arrayOf(clazz), IActivityManagerProxy_(instance))
}